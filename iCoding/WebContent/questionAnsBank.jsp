...
<script>
	$(function(){		
			$.ajax({
				url:"getPage?currentPage="+1+"&type=answer",
				type:"post",
				data:{},
				dataType:"json",
				success:function(dataJson){	
					...
					$tbody.empty();
					var queList = dataJson.queAutList;
					var answer = "answer";
					for(i=0;i<queList.length;i++)
					{
						...
						$tr.html(
								"<td></td>"+
                        		 ...
                        		 "<td><a href='getquestionByid?id="+queList[i].qid+"&type="+answer+"'>"+queList[i].questionTitle+"</a></td>"+
                        		 "<td><span >"+queList[i].username+"</span></td>"+
                        		 "<td><span style='color: grey;'>简单</span></td>"+
    							 "<td><span style='color: grey;'>1000</span></td>"
                        		);
                        $tbody.append($tr);
	...
	function changePage(num)
	{
		...
		$.ajax({
			url:"getPage?currentPage="+num+"&type=answer",
			type:"post",
			data:{},
			dataType:"json",
			success:function(dataJson){	
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="topNavBar">
            <ul class="nav navbar-nav">
                ...
                <li><a href="questionBank.jsp">题库</a></li>
                <li class=" active ">
                    <a href="#"  >
                        题解
                    </a>
...
<div class="container">
        <div class="panel panel-default">
            <div class="panel-body">
                    ...
                    <h1 class="text-center">iCoding题解</h1>
