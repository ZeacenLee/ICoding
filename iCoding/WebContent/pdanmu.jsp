  		   ...
  		   success:function(jsondata){
  			   ...
  			   for(var i=0;i<jsondata.length;i++){
  				 ...
  				 var $p3 = $("<td></td>");
  				   ...
  				   $p1.html(i+1);
  				   $p2.html(jsondata[i].barrage);
  				   $p3.html(jsondata[i].date);
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="topNavBar">
            <ul class="nav navbar-nav">
                ...
                <li class=""><a href="questionAnsBank.jsp">题解</a></li>
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-tabs" style="font-size: 17px;">
                            <li role="presentation" >
                                <a href="personal_iCoding.jsp" class="user-myspace-base-subtitle dropdown-toggle" >
                                    题解
                                    <b class="caret"></b>
                                </a>
                            </li>
